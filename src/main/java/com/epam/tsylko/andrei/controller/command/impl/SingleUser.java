...
public class SingleUser implements Command {
    private static Logger logger = Logger.getLogger(SingleUser.class);
    private String response;
    @Override
    public String execute(String request) {
        logger.debug("SingleUser.execute");
        ...
        try {
            ...
            logger.error("request params " + SingleUser.class.getName() + " was incorrect: " + request, e);
    ...
    public boolean getAccess(String request) {
        logger.debug("SingleUser.getAccess");
        ServiceFactory serviceFactory = ServiceFactory.getInstance();
