...
public class GetEditUserCommand implements Command {
    private final static Logger logger = Logger.getLogger(GetEditUserCommand.class);
    ...
    public String execute(String request) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("GetEditUserCommand.execute()");
        }
...
//            TODO Address set as 0;
            ...
            logger.error("request params " + GetEditUserCommand.class.getName() + " was incorrect: " + request, e);
    ...
    public boolean getAccess(String request) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("GetEditUserCommand.getAccess()");
        }
