...
public class GetCancelBookReservationCommand implements Command {
    private final static Logger logger = Logger.getLogger(GetCancelBookReservationCommand.class);
    ...
    public String execute(String request) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("GetCancelBookReservationCommand.execute()");
        }
        ...
        try {
            ...
            logger.error("request params " + GetCancelBookReservationCommand.class.getName() + " was incorrect: " + request, e);
    ...
    public boolean getAccess(String request) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("GetCancelBookReservationCommand.getAccess()");
        }
