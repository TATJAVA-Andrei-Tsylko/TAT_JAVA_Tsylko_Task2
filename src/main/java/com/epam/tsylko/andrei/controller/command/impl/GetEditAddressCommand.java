...
public class GetEditAddressCommand implements Command{
    ...
    public String execute(String request) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("GetEditAddressCommand.execute()");
        }
        ...
        try{
            ...
            logger.error("request params " + GetEditAddressCommand.class.getName() + " was incorrect: " + request,e);
    ...
    public boolean getAccess(String request) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("GetEditAddressCommand.getAccess()");
        }
